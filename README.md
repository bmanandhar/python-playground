...
Such dunder exist for ***almost every operator***! [Reference on more](https://www.python-course.eu/python3_magic_methods.php).
...
Clone down [this repo](https://git.generalassemb.ly/sf-wdi-49/codebar) and follow the instructions in the readme.